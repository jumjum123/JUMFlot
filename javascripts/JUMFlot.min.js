...
Math.abs(b.p2c(a)-e),f<=p.nearBy.distance&&(k=[t,q/h]))}return k},findMode:"circle",drawEdit:function(u,r,t,p){var q=p.xaxis,m=p.yaxis;if(!(r<q.min||r>q.max||t<m.min||t>m.max))switch(p.nearBy.findMode){case "circle":var k=p.points.radius+p.points.lineWidth/2;u.lineWidth=k;u.strokeStyle=e.color.parse(p.color).scale("a",0.5).toString();p=1.5*k;r=q.p2c(r);t=m.p2c(t);u.beginPath();u.arc(r,t,p,0,2*Math.PI,!1);u.fillStyle="#ff8080";u.fill();u.lineWidth=2;u.moveTo(r,t-p);u.lineTo(r,t+p);u.moveTo(r-p,t);
u.lineTo(r+p,t);u.closePath();u.stroke();break;case "vertical":u.lineWidth=2;u.strokeStyle=e.color.parse(p.color).scale("a",0.5).toString();u.beginPath();u.moveTo(q.p2c(r),m.p2c(t));u.lineTo(q.p2c(r+p.nearBy.width),m.p2c(t));u.closePath();u.stroke();break;case "horizontal":u.lineWidth=4,u.strokeStyle=e.color.parse(p.color).scale("a",0.5).toString(),u.beginPath(),u.moveTo(q.p2c(r),m.p2c(t)),t=0>m.datamin?Math.max(0,m.datamin):Math.min(0,m.datamin),u.lineTo(q.p2c(r),m.p2c(t)),u.closePath(),u.stroke()}},
drawHover:function(e,r,t){}}},grid:{editable:!1}},name:"mouse",version:"0.2"});var x=e.plot.JUMlib.library.between})(jQuery);(function(e){e.plot.plugins.push({init:function(x,u){function r(b,c){a=b.getOptions();var d=a.grid.background.setZIndex;m=new q("flot-background",b.getPlaceholder());!0===e.isNumeric(d)?(e(b.getPlaceholder().children(".flot-overlay")).css("z-index",d+1),e(b.getCanvas()).css("z-index",d),e(m.element).css("z-index",d-1)):!0===a.grid.background.setZIndex?(e(b.getPlaceholder().children(".flot-overlay")).css("z-index",2),e(b.getCanvas()).css("z-index",1),e(m.element).css("z-index",0)):e(m.element).css("z-index",
...
c,c.data[a],!1);b.restore()}}function q(f,b,c,d){function h(b,c,d,l){b=null;return b=[d,a.series.justEditing[1].dataIndex]}function g(b,c,a,d){var l=null;if(!0===d.candlestick.show)for(var g=0;g<d.data.length;g++){var h,n,f,e,k;k=d.data[g];h=d.xaxis.p2c(k[0])-d.candlestick.barWidth/2;n=d.yaxis.p2c(k[1])-d.candlestick.rangeWidth/2;f=d.yaxis.p2c(k[2])-d.candlestick.rangeWidth/2;e=d.yaxis.p2c(k[3])-d.candlestick.rangeWidth/2;k=d.yaxis.p2c(k[4])-d.candlestick.rangeWidth/2;u(b,h,h+d.candlestick.barWidth)&&
(u(c,e,k)&&(l=[a,g],d.editMode="x",d.nearBy.findMode="horizontal"),u(c,n,n+d.candlestick.rangeWidth)&&(l=[a,[g,1]],d.editMode="y",d.nearBy.findMode="vertical"),u(c,f,f+d.candlestick.rangeWidth)&&(l=[a,[g,2]],d.editMode="y",d.nearBy.findMode="vertical"),u(c,e,e+d.candlestick.rangeWidth)&&(l=[a,[g,3]],d.editMode="y",d.nearBy.findMode="vertical"),u(c,k,k+d.candlestick.rangeWidth)&&(l=[a,[g,4]],d.editMode="y",d.nearBy.findMode="vertical"))}return l}function n(d,c,b,a){for(var l=null,g=0;g<a.data.length;g++){var h,
n,f;f=a.data[g];h=a.xaxis.p2c(f[0])-a.candlestick.barWidth/2;n=a.yaxis.p2c(f[3]);f=a.yaxis.p2c(f[4]);u(d,h,h+a.candlestick.barWidth)&&u(c,n,f)&&(l=[b,g])}return l}var l=null;!0===d.candlestick.show&&(a.series.justEditing?a.series.justEditing[1].seriesIndex===c&&(l=h(f,b,c,d)):l=a.grid.editable?g(f,b,c,d):n(f,b,c,d));return l}function m(a,b,c){a.save();b.candlestick.drawCandlestick(a,b,c.length?b.data[c[0]]:b.data[c],!0);a.restore()}var k=null,a=null;r.hooks.processOptions.push(function(f,b){b.series.candlestick.active&&
...
B=b.top+h.yaxis.p2c(s.data[w][1]),C=b.top+h.yaxis.p2c(s.data[z][1]),m=A,D=s.gantt.connectSteps.lineWidth,p=s.gantt.connectSteps.color;m.beginPath();m.lineWidth=D;m.strokeStyle=p;m.moveTo(v,B);m.lineTo(v,C);m.stroke()}}}function k(a,d,c,g,e){var f,k,v;f=b.left+h.xaxis.p2c(c[0]);f=Math.min(Math.max(b.left,f),b.left+p.width());k=b.top+h.yaxis.p2c(c[1]);v=b.left+h.xaxis.p2c(c[2]);v=Math.min(Math.max(v,b.left),b.left+p.width());if(v>b.left||f>b.left)if(f<b.left+p.width()||v<b.left+p.width())4===c.length?
x(a,d,c,f,k,v,g,e):d.gantt.drawstep(a,d,c,f,k,v,g,e)}function a(a,d,b,g){function h(a,d,c,b){var g=null;if(b.gantt.show)for(var l=0;l<b.data.length;l++){var n=b.data[l],s=b.xaxis.p2c(n[0]),e=b.xaxis.p2c(n[2]);Math.abs(b.yaxis.p2c(n[1])-d)<=b.gantt.barheight/2&&t(a,s,e)&&(g=[c,l])}return g}function e(a,d,c,b){var g=null;if(b.gantt.show)for(var l=0;l<b.data.length;l++){var h=b.data[l],n=b.xaxis.p2c(h[0]),s=b.xaxis.p2c(h[2]);Math.abs(b.yaxis.p2c(h[1])-d)<=b.gantt.barheight/2&&(t(a,n,s)&&(g=[c,l],b.editMode=
